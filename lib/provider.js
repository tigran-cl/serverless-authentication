...
var Provider = exports.Provider = function () {
  ...
  _createClass(Provider, [{
    ...
    value: function signin(_ref, callback) {
      ...
      var access_type = _ref.access_type;
    ...
    value: function callback(_ref2, _ref3, additionalParams, cb) {
      ...
      var createMappedProfile = function createMappedProfile(accessData) {
        return new _bluebird2.default(function (resolve, reject) {
          ...
          var refresh_token = _JSON$parse.refresh_token;

          _request2.default.get({url: profile_uri, headers: {Authorization: 'Bearer '+access_token}}, function (error, httpResponse, profileData) {
            if (error) {
              reject(error);
            } else if (!profileData) {
