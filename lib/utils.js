...
var Utils = exports.Utils = function () {
  ...
  _createClass(Utils, null, [{
     ...
     */
    value: function redirectUrlBuilder() {
    ...
    value: function tokenResponse(data, _ref, callback) {
      var redirectClientUri = _ref.redirectClientUri;
      var tokenSecret = _ref.tokenSecret;
      ...
      var url = this.urlBuilder(redirectClientUri, params);
    ...
    value: function errorResponse(params, _ref2, callback) {
      var redirectClientUri = _ref2.redirectClientUri;
